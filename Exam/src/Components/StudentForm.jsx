...
function Form() {
    ...
    function handleSubmit(e) {
        ...
        if ("id" in ob) {
            ...
            dispatch(addProduct({ name: ob.name, fathername: ob.fathername, fathername: ob.fathername, address: ob.address }));
        }
        ...
        <div >
            ...
            <form onSubmit={handleSubmit} >
                ...
                <input
                    ...
                    required
                />
                <button className="btn btn-success" type="submit">{ob.id ? "Update" : "Add"} Detalis</button>
            </form><br></br><br></br>
            <div>
                ...
                <div className="">
                    {datas.map((el) => (
                        <div key={el.id} className="border w-25 mt-5" >
                            ...
                            <p></p>
                            <div>
                                <button onClick={() => handleEdit(el)} className="btn btn-success">Edit</button>
                                <button onClick={() => handleDelete(el.id)} className="btn btn-danger ms-2">Delete</button>
                            </div>
                        </div>
                    ))}
                </div>
